...
func init() {
	...
	err = Engine.Sync2(new(models.Machine), new(models.Vpn), new(models.Cdn), new(models.More), new(models.User), new(models.Userauth), new(models.Group), new(models.History))
	if err != nil {
		panic(err)
	}
}
